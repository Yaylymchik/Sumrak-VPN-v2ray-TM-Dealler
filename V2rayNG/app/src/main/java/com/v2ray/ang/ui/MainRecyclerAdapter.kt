...
class MainRecyclerAdapter(
    ...
    override fun onBindViewHolder(holder: BaseViewHolder, position: Int) {
        if (holder is MainViewHolder) {
            ...
            holder.itemMainBinding.itemBg.setBackgroundResource(
            ...
            //layoutIndicator — selected state uses card background stripe
            ...
            if ((aff?.testDelayMillis ?: 0L) < 0L) {
                ...
                holder.itemMainBinding.tvTestResult.setBackgroundResource(R.drawable.bg_chip_error)
            } else {
                holder.itemMainBinding.tvTestResult.setTextColor(ContextCompat.getColor(context, R.color.colorPing))
                holder.itemMainBinding.tvTestResult.setBackgroundResource(R.drawable.bg_chip_success)
            }
            ...
            //layout - hide share, edit, more buttons per SumraX UI
