...
object AppConfig {
    ...
    const val SUBSCRIPTION_IMPORT_SUB_REMARKS = "import sub"
    ...
    const val PREF_ROUTING_ENABLED = "pref_routing_enabled"
    const val PREF_DEFAULT_USER_AGENT = "pref_default_user_agent"
    const val PREF_FORCE_GLOBAL_USER_AGENT = "pref_force_global_user_agent"
    const val PREF_SUBSCRIPTION_AUTO_UPDATE_ENABLE = "pref_subscription_auto_update_enable"
    const val PREF_SUBSCRIPTION_UPDATE_ON_LAUNCH = "pref_subscription_update_on_launch"
    const val PREF_AUTO_CHECK_UPDATE = "pref_auto_check_update"
    const val PREF_APP_UPDATE_API_URL = "pref_app_update_api_url"
    ...
    const val PREF_NOISE_ENABLED = "pref_noise_enabled"
    const val PREF_NOISE_RAND = "pref_noise_rand"
    const val PREF_NOISE_DELAY = "pref_noise_delay"
    ...
    const val PREF_AUTO_CONNECT_TYPE = "pref_auto_connect_type"
    const val AUTO_CONNECT_LAST_USED = "lastused"
    const val AUTO_CONNECT_LOWEST_DELAY = "lowestdelay"
    const val AUTO_CONNECT_RANDOM = "random"
    const val PING_TYPE_TCP = "tcp"
    const val PING_TYPE_ICMP = "icmp"
    const val PING_TYPE_PROXY = "proxy"
    const val PING_TYPE_PROXY_HEAD = "proxy-head"
    const val PREF_FAVORITE_SERVERS = "pref_favorite_servers"
    const val PREF_RECENT_SERVERS = "pref_recent_servers"
    const val PREF_ONBOARDING_DONE = "pref_onboarding_done"
    const val PREF_IP_TYPE = "pref_ip_type"
    const val PREF_XRAY_TUN_ENABLED = "pref_xray_tun_enabled"
    const val PREF_XRAY_TUN_MTU = "pref_xray_tun_mtu"
    const val PREF_BLOCK_BIND_TO_DEVICE = "pref_block_bindtodevice_enabled"
    ...
    const val PREF_AUTO_SELECT_PROFILE = "pref_auto_select_profile"
    const val PREF_REAL_PING_CONCURRENCY = "pref_real_ping_concurrency"
    const val PREF_PING_TYPE = "pref_ping_type"
    const val PREF_PING_ON_LAUNCH = "pref_ping_on_launch"
    const val PREF_FONT_SIZE = "pref_font_size"
    const val PREF_SUBSCRIPTIONS_MANAGE = "pref_subscriptions_manage"
    const val PREF_MONTHLY_TRAFFIC_PERIOD = "pref_monthly_traffic_period"
    const val PREF_MONTHLY_PROXY_UP = "pref_monthly_proxy_up"
    const val PREF_MONTHLY_PROXY_DOWN = "pref_monthly_proxy_down"
    const val PREF_MONTHLY_DIRECT_UP = "pref_monthly_direct_up"
    const val PREF_MONTHLY_DIRECT_DOWN = "pref_monthly_direct_down"
    const val PREF_MONTHLY_LAST_RESET_NOTIFIED = "pref_monthly_last_reset_notified"
    const val PREF_EXCLUDED_ROUTES = "pref_excluded_routes"
    ...
    const val APP_URL = "$GITHUB_URL/Yaylymchik/Sumrak-VPN-v2ray-TM-Dealler"
    const val APP_API_URL = "https://api.github.com/repos/Yaylymchik/Sumrak-VPN-v2ray-TM-Dealler/releases"
    const val APP_ISSUES_URL = "$APP_URL/issues"
    const val APP_WIKI_MODE = "$APP_URL#readme"
    const val APP_PRIVACY_POLICY = "$APP_URL#readme"
    ...
    const val DEFAULT_USER_AGENT = "chrome-android"
    ...
    const val RAY_NG_CHANNEL_NAME = "SumraX Background Service"
    const val RAY_NG_MONTHLY_CHANNEL_ID = "RAY_NG_MONTHLY_CH_ID"
    const val RAY_NG_MONTHLY_CHANNEL_NAME = "SumraX Traffic Reports"
    const val NOTIFICATION_ID_MONTHLY_RESET = 2
