...
class GroupServerFragment : BaseFragment<FragmentGroupServerBinding>(),
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        addCustomDividerToRecyclerView(binding.recyclerView, R.drawable.custom_divider_glass)
        binding.recyclerView.adapter = adapter

        binding.refreshLayout.setColorSchemeColors(
            ContextCompat.getColor(requireContext(), R.color.sumrax_accent)
        )
        binding.refreshLayout.setProgressBackgroundColorSchemeColor(
            ContextCompat.getColor(requireContext(), R.color.sumrax_surface)
        )
...
//        binding.refreshLayout.setDistanceToTriggerSync((160 * resources.displayMetrics.density).toInt())
    ...
    private fun setSelectServer(guid: String) {
        ...
        ownerActivity.refreshDaysRemaining()
        ownerActivity.refreshServerPickerBar()
        ownerActivity.showHomeScreen()
    }
